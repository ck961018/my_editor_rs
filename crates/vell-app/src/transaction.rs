...
use vell_core::content::{ContentTransaction, ContentTransactionError};
...
mod tests {
    use super::*;
    use vell_core::buffer::BufferTransactionData;
    use vell_core::content::ContentTransaction;
    use vell_core::transaction::{TextChangeSet, TextEdit, TextStateId, TextTransactionData};
