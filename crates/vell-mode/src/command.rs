...
pub struct ModeInputCommand {
    mode: ModeName,
    key: vell_protocol::key_event::KeyEvent,
}

impl ModeInputCommand {
    pub fn new(mode: ModeName, key: vell_protocol::key_event::KeyEvent) -> Self {
        Self { mode, key }
    }
    ...
    pub fn key(&self) -> vell_protocol::key_event::KeyEvent {
        self.key
    }
}
